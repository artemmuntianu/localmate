...
## Integration Note
- This project is integrated with the **CommonAgentSDK** located at `E:\CommonAgentSDK`.
- Use the tools provided in `/tools` (linked to CommonAgentSDK) for dependency and code analysis.
- Follow the core guidelines and templates provided in `/docs/template_agents.md`.
