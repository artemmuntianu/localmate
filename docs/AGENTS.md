...
This directory contains project-level documentation deep dives and reference copies of shared standards for LocalMate.
...
| `CONSTITUTION.md` (root) | Canonical architecture, tech stack, and core invariants |
...
2. When changing project architecture or backend invariants, update `CONSTITUTION.md` and the relevant layer's `AGENTS.md` in the same change.
